<?php 
  ...
  $historialproductos = $productoBusiness ->getAllTBHistorialProducto();
...
">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item ">
            <a href="historialview.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Historial de productos</h1>
          </div><!-- /.col -->
    ...
    <section class="content">
      <div class="container-fluid">
       ...
       <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="tabla-historial" class="tabla-historial table table-bordered table-hover">
                  <thead>
                  <tr>
                    <th>Fecha ingreso</th>
                    <th>Producto</th>
                  ...
                  <tbody>
                    <?php 
                       ...
                       foreach($historialproductos as $historial){
                          echo '<tr>';
                          echo '<td>'.$historial['historialfecha'].'</td>';
                          echo '<td>'.$historial['productonombre'].'</td>';
                          echo '</tr>';
                       }
