<?php 
  ...
  $totalOrdenes = $ordenBusiness->getTotalOrdenes();
 $totalProductos = $productoBusiness->getTotalProductos();
 $totalGanancias = $ordenBusiness->getTotalGanancias();
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php echo $totalOrdenes[0]['totalordenes'] ?></h3>
